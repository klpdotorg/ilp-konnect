...
public class ReportAdapter extends RecyclerView.Adapter<ReportAdapter.ReportViewHolder> {
    ...
    public class ReportViewHolder extends RecyclerView.ViewHolder {
        ...
        public ReportViewHolder(View itemView) {
            ...
            txtdn= itemView.findViewById(R.id.txtdn);
            school_count= itemView.findViewById(R.id.school_count);
            txtyesperc= itemView.findViewById(R.id.txtyesperc);
            txtnoperc= itemView.findViewById(R.id.txtnoperc);
            txtdnperc= itemView.findViewById(R.id.txtdnperc);
