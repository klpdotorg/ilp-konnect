...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button syncSurvey = (Button) findViewById(R.id.syncSurvey);
        syncSurvey.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sync1(true);
            }
...
//            Log.d(this.toString(), "if you're here, you're in trouble");
    ...
    public void sync1(final boolean var) {
        ...
        if (data.trim().equalsIgnoreCase(res) && var) {
            ...
            DialogConstants d = new DialogConstants(MainActivity.this, "Data Already in Sync");
            d.show();
        } else {
...
//        API_URLS.put("story", story_url);
    ...
    public String doUploadForSyncSurvey() {
...
/*    public JSONObject doUpload() {
        ...
        Log.d("shri", "=====" + requestJson.toString());
