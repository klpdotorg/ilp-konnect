...
import in.org.klp.ilpkonnect.utils.KLPVolleySingleton;
...
//Toast.makeText(getApplicationContext(),android.os.Build.VERSION.SDK_INT+"",Toast.LENGTH_SHORT).show();
        ...
        if (mSession.isLoggedIn()) {
            ...
            Intent intent = new Intent(LoginActivity.this, AppSettings.class);
        ...
        if (cancel) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST,
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    /*    DialogConstants dialogConstants=new DialogConstants(LoginActivity.this,getString(R.string.noInternetCon));
                        dialogConstants.show();*/

                        showSignupResultDialog(
                                getResources().getString(R.string.app_name),
                                getString(R.string.noInternetCon),
                                getResources().getString(R.string.Ok));
                    } else {

                        NetworkResponse networkResponse = error.networkResponse;
                        String responseDetail = "some thing went wrong please try later";
                        if (networkResponse != null && networkResponse.data != null) {
                            try {
                                JSONObject jsonObject = new JSONObject(new String(networkResponse.data));
                                responseDetail = jsonObject.get("detail").toString();
                        ...
                        //here activity means your activity class
                     /*   DialogConstants dialogConstants = new DialogConstants(LoginActivity.this, responseDetail);
                        ...
                        //   Toast.makeText(getApplicationContext(),responseDetail,Toast.LENGTH_SHORT).show();
    ...
    protected void finishLogin(String userInfo) {
        ...
        try {
            ...
            if (userLoginInfo.has("token")) {
                ...
                {
                    users=userLoginInfo.getString("user_type");
